import VectorFooter from "../heplers/img/VectorFooter.png";
...
function Footer(){
  ...
  {/* Nội dung chính */}
  <div className="relative z-[1] 4k:max-w-[75%] sm:max-w-[80%] max-w-[95%] mx-auto grid lg:grid-cols-13 grid-cols-5 lg:pb-[20px] pb-[50px] gap-[5%] xl:gap-[2%]">
    ...
    <div className="col-span-4 mr-[-5%]">
      ...
      <div className="sm:block hidden mt-0.5 text-[14px] lg:text-[12px] text-justify text-white xl:text-sm 4k:text-xl ">
    ...
    <div className="col-span-3">
      ...
      <div className="mt-0.5 sm:block hidden text-[14px] lg:text-[12px] text-justify text-white xl:text-sm 4k:text-xl opacity-80">
